...
public class DrawSurface extends PApplet{
	...
	public void draw() { 
		...
		//Line leftEdge, rightEdge, use when moving person make them not go out the window
		
		/* if person intersects with another line
		 * change this{}
		 * else do this{}
		 *  draw person 
		 */
		
		if(person.body.intersects(house.doorL) == true || person.body.intersects(house.doorR) == true)
		{
			fill(253, 95, 0);
			person.draw(this);
		}
