 ...
 * - this class, unlike RectangleB doesn't depend on another class/object (Line) to create 
 * - RectangleB uses more RAM (objects vs. primitives) end up storing coordinates multiple times
 * - easy to modify width/height
 *  
 * ENCAPSULATION: code in any way you want as long as it looks the same from the outside
 */
