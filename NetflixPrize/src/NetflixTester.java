...
public class NetflixTester {
	...
	// nothing should be changed in this tester except these 5 fields
	
	public static final String baseFile = "test-files" + FileIO.fileSeparator + "1Ratings.csv";
	public static final String testFile = "test-files" + FileIO.fileSeparator + "1Tests.csv";
	...
	public static void main(String[] args) {
		...
		long millis = time % (time%60000/1000);
